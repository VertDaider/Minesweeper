...
public class Game {
    ...
    public boolean isFirstBombBox(Coord coord) {
        return bomb.get(coord) == Box.BOMB && flag.getCountOfClosedBoxes() == (Ranges.getSize().x * Ranges.getSize().y);
    }
